...
#
# SNOWFLAKE_HOST is injected by the SiS runtime and is absent in local dev.
# Using only this env var avoids false-positives: get_active_session() can
# succeed locally once a Snowpark session has been created and registered,
# which would incorrectly set _IS_SIS=True and route cortex-code to SPCS.
# ---------------------------------------------------------------------------

_IS_SIS = bool(os.environ.get("SNOWFLAKE_HOST"))
