...
Non-agentic runs (8 of 16) used \texttt{SNOWFLAKE.\allowbreak CORTEX.\allowbreak COMPLETE(\allowbreak 'claude-opus-4-6',\allowbreak ...)} with a fixed 8,192-token output limit. Agentic runs (8 of 16) launched parallel Cortex Code subagents with full tool access and no token output cap. All 16 runs used \texttt{claude-opus-4-6} exclusively as the respondent model to avoid cross-model contamination.
