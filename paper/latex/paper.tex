...
\midrule
AI Observability \& Evaluation          & 80.2\% & 84.0\% & 83.3\% & 73.3\% & 80.0\% & \textbf{\textit{Debug}} \\
Apache Iceberg Tables                   & 88.3\% & 80.7\% & 97.3\% & 88.0\% & 87.3\% & \textbf{\textit{Explain}} \\
Collaboration \& Data Sharing           & 86.8\% & 86.0\% & 88.0\% & 85.3\% & 88.0\% & \textbf{\textit{Debug}} \\
Cortex AI Function Studio               & 84.7\% & 90.0\% & 78.0\% & 84.7\% & 86.0\% & \textbf{\textit{Implement}} \\
Cortex AI Functions                     & 83.0\% & 86.0\% & 99.3\% & 64.0\% & 82.7\% & \textbf{\textit{Debug}} \\
Cortex Agents                           & 78.5\% & 86.0\% & 93.3\% & 52.7\% & 82.0\% & \textbf{\textit{Debug}} \\
Cortex Code                             & 88.8\% & 86.0\% & 90.0\% & 94.0\% & 85.3\% & \textbf{\textit{Compare}} \\
Cortex Search                           & 88.4\% & 90.7\% & 87.3\% & 92.7\% & 82.7\% & \textbf{\textit{Compare}} \\
Cost Management                         & 87.5\% & 88.7\% & 79.3\% & 87.3\% & 94.7\% & \textbf{\textit{Implement}} \\
Data Clean Rooms                        & 79.3\% & 84.0\% & 74.0\% & 76.7\% & 82.7\% & \textbf{\textit{Implement}} \\
Data Governance \& Security             & 90.8\% & 86.7\% & 96.7\% & 88.0\% & 92.0\% & \textbf{\textit{Explain}} \\
Data Loading (COPY, Snowpipe, Streaming)& 77.2\% & 85.3\% & 82.0\% & 54.7\% & 86.7\% & \textbf{\textit{Debug}} \\
Data Pipelines (Streams, Tasks, Snowpipe)& 81.5\% & 88.7\% & 71.3\% & 81.3\% & 84.7\% & \textbf{\textit{Implement}} \\
Data Quality \& Observability           & 69.2\% & 87.3\% & 52.7\% & 86.0\% & 50.7\% & \textbf{\textit{Compare}} \\
Database Change Management (DCM)        & 78.0\% & 82.0\% & 78.7\% & 67.3\% & 84.0\% & \textbf{\textit{Debug}} \\
Database Security                       & 84.2\% & 95.3\% & 89.3\% & 82.0\% & 70.0\% & \textbf{\textit{Compare}} \\
Dynamic Tables                          & 75.0\% & 94.7\% & 76.7\% & 64.7\% & 64.0\% & \textbf{\textit{Compare}} \\
Hybrid Tables                           & 82.8\% & 86.0\% & 87.3\% & 78.7\% & 79.3\% & \textbf{\textit{Debug}} \\
Native Apps Framework                   & 82.8\% & 82.0\% & 79.3\% & 83.3\% & 86.7\% & \textbf{\textit{Implement}} \\
Openflow                                & 83.2\% & 86.7\% & 80.7\% & 83.3\% & 82.0\% & \textbf{\textit{Implement}} \\
SQL Performance \& Optimization         & 82.7\% & 76.7\% & 92.7\% & 85.3\% & 76.0\% & \textbf{\textit{Compare}} \\
Semantic Views \& Cortex Analyst        & 79.2\% & 80.0\% & 75.3\% & 73.3\% & 88.0\% & \textbf{\textit{Debug}} \\
Snowflake Fundamentals \& Architecture  & 87.5\% & 88.0\% & 89.3\% & 83.3\% & 89.3\% & \textbf{\textit{Debug}} \\
Snowflake ML                            & 84.3\% & 89.3\% & 76.0\% & 81.3\% & 90.7\% & \textbf{\textit{Implement}} \\
Snowflake Notebooks (Workspaces)        & 80.8\% & 84.7\% & 79.3\% & 80.7\% & 78.7\% & \textbf{\textit{Compare}} \\
Snowflake Postgres                      & 61.8\% & 80.0\% & 45.3\% & 39.3\% & 82.7\% & \textbf{\textit{Debug}} \\
Snowpark                                & 86.2\% & 87.3\% & 80.0\% & 93.3\% & 84.0\% & \textbf{\textit{Implement}} \\
Snowpark Connect \& Migration           & 81.2\% & 89.3\% & 84.7\% & 78.7\% & 72.0\% & \textbf{\textit{Compare}} \\
Snowpark Container Services (SPCS)      & 85.3\% & 96.7\% & 82.0\% & 86.7\% & 76.0\% & \textbf{\textit{Compare}} \\
Snowsight                               & 76.8\% & 84.0\% & 84.7\% & 53.3\% & 85.3\% & \textbf{\textit{Debug}} \\
Streamlit in Snowflake                  & 86.3\% & 92.0\% & 90.7\% & 72.0\% & 90.7\% & \textbf{\textit{Debug}} \\
dbt Projects on Snowflake               & 90.3\% & 92.7\% & 94.0\% & 86.0\% & 88.7\% & \textbf{\textit{Debug}} \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{enumerate}[resume]
  \item \textbf{Debug documentation is the most widespread gap.} Debug is the weakest question type in 13 of 32 categories (41\%), with gaps as large as 25.8pp (Cortex Agents), 23.5pp (Snowsight), and 22.5pp (Snowflake Postgres). These are not AI failures; they are signals that troubleshooting guides, runbooks, and documented error patterns are missing or sparse in those product areas.

  \item \textbf{Compare and Implement gaps are the second and third most common failure patterns.} Compare is weakest in 9 of 32 categories (28\%), indicating absent decision guidance and ``when to use X vs Y'' content. Implement is weakest in 8 of 32 categories (25\%), reflecting incomplete how-to tutorials and code examples. See Table~\ref{tab:pm_action} (PM Action Framework) in the Results section for the documentation action that maps to each gap type.
